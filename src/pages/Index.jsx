    ...
    <Container maxW="container.xl" p={5}>
      <VStack spacing={8}>
        ...
        <Flex w="full" direction={{ base: "column", md: "row" }} gap={6}>
          {}
          <Box w={{ base: "full", lg: "70%" }} p={5} borderWidth="1px" borderRadius="lg">
            <VStack spacing={6}>
              <Box w="full" h="500px" p={3} overflowY="auto" borderWidth="1px" borderRadius="lg" bg="gray.50">
                {}
              </Box>
              <Textarea placeholder="Enter your message here..." size="lg" height="100px" />
              <Button leftIcon={<FaPlus />} size="lg" px={8}>
                Send Message
              </Button>
            </VStack>
          </Box>
